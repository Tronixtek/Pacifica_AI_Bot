(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,82418,e=>{"use strict";var a=e.i(47167),s=e.i(43476),r=e.i(71645);let t=a.default.env.NEXT_PUBLIC_TRADER_API_URL??"",i=e=>`${e>=0?"+":"−"}$${Math.abs(e).toFixed(2)}`;function n(e){return e>0?"pos":e<0?"neg":"flat"}e.s(["BotPerformanceBoard",0,function(){let[e,a]=(0,r.useState)(null),[o,d]=(0,r.useState)(null),[l,c]=(0,r.useState)(null),[p,x]=(0,r.useState)(null),[m,g]=(0,r.useState)(null),h=async e=>{c(e.botId);try{let s=e.paused?"resume":"pause",r=await fetch(`${t}/api/bots/${e.botId}/${s}`,{method:"POST"}),i=await r.json();x(i.message??null),a(a=>a?{...a,bots:a.bots.map(a=>a.botId===e.botId?{...a,paused:i.paused}:a)}:a)}catch(e){x(e instanceof Error?e.message:String(e))}finally{c(null)}};(0,r.useEffect)(()=>{let e=!0,s=async()=>{try{let s=await fetch(`${t}/api/bots`,{cache:"no-store"});if(!s.ok)throw Error(`HTTP ${s.status}`);let r=await s.json();e&&(a(r),d(null));try{let a=await fetch(`${t}/api/bots/edge/activity`,{cache:"no-store"});a.ok&&e&&g(await a.json())}catch{}}catch(a){e&&d(a instanceof Error?a.message:String(a))}};s();let r=setInterval(s,5e3);return()=>{e=!1,clearInterval(r)}},[]);let b=e?.bots.reduce((e,a)=>e+a.equityImpactUsd,0)??0;return(0,s.jsxs)("main",{className:"board",children:[(0,s.jsxs)("header",{className:"head",children:[(0,s.jsxs)("div",{children:[(0,s.jsx)("h1",{children:"Bot Performance"}),(0,s.jsx)("p",{className:"sub",children:"Three strategies, one demo account, separated by magic number."})]}),(0,s.jsx)("div",{className:"acct",children:e?.accountEquityUsd!=null&&(0,s.jsxs)(s.Fragment,{children:[(0,s.jsxs)("span",{className:"acct-eq",children:["$",e.accountEquityUsd.toFixed(2)]}),(0,s.jsxs)("span",{className:"acct-lbl",children:["equity · ",e.openPositions," open"]})]})})]}),o&&(0,s.jsxs)("div",{className:"err",children:["Cannot reach the trader service",t?` at ${t}`:""," — ",o]}),!e&&!o&&(0,s.jsx)("div",{className:"err",children:"Loading…"}),p&&(0,s.jsx)("div",{className:"notice",onClick:()=>x(null),children:p}),(0,s.jsx)("div",{className:"grid",children:e?.bots.map(e=>(0,s.jsxs)("section",{className:`card ${n(e.equityImpactUsd)}`,children:[(0,s.jsxs)("div",{className:"card-top",children:[(0,s.jsx)("h2",{children:e.label}),(0,s.jsxs)("span",{className:"magic",children:["#",e.magicNumber]})]}),e.archived?(0,s.jsxs)("div",{className:"archived-flag",children:[(0,s.jsx)("strong",{children:"ARCHIVED"}),"— retired, not running.",e.archivedReason?` ${e.archivedReason}`:""," ","Figures below are history."]}):e.paused?(0,s.jsx)("div",{className:"paused-flag",children:"Paused — no new trades. Open positions still managed."}):null,(0,s.jsx)("div",{className:`headline ${n(e.equityImpactUsd)}`,children:i(e.equityImpactUsd)}),(0,s.jsxs)("div",{className:"headline-sub",children:[i(e.realisedUsd)," realised",0!==e.unrealisedUsd&&(0,s.jsxs)(s.Fragment,{children:[" · ",i(e.unrealisedUsd)," open"]})]}),(0,s.jsxs)("dl",{className:"stats",children:[(0,s.jsxs)("div",{children:[(0,s.jsx)("dt",{children:"Trades"}),(0,s.jsx)("dd",{children:e.trades})]}),(0,s.jsxs)("div",{children:[(0,s.jsx)("dt",{children:"Win rate"}),(0,s.jsx)("dd",{children:e.trades?`${e.winRate}%`:"—"})]}),(0,s.jsxs)("div",{children:[(0,s.jsx)("dt",{children:"Avg / trade"}),(0,s.jsx)("dd",{className:n(e.averageUsd),children:e.trades?i(e.averageUsd):"—"})]}),(0,s.jsxs)("div",{children:[(0,s.jsx)("dt",{children:"Open"}),(0,s.jsxs)("dd",{children:[e.openPositions,e.openVolume>0&&(0,s.jsxs)("span",{className:"dim",children:[" · ",e.openVolume," lots"]})]})]}),(0,s.jsxs)("div",{children:[(0,s.jsx)("dt",{children:"Best"}),(0,s.jsx)("dd",{className:"pos",children:e.trades?i(e.bestUsd):"—"})]}),(0,s.jsxs)("div",{children:[(0,s.jsx)("dt",{children:"Worst"}),(0,s.jsx)("dd",{className:"neg",children:e.trades?i(e.worstUsd):"—"})]})]}),(0,s.jsxs)("footer",{className:"card-foot",children:[(0,s.jsx)("span",{children:e.symbols.length>0?e.symbols.join(" · "):"no trades yet"}),e.canPause&&!e.archived&&(0,s.jsx)("button",{className:e.paused?"btn resume":"btn pause",onClick:()=>h(e),disabled:l===e.botId,children:l===e.botId?"…":e.paused?"Resume":"Stop"})]})]},e.botId))}),m&&m.markets.length>0&&(0,s.jsxs)("section",{className:"live",children:[(0,s.jsxs)("div",{className:"live-head",children:[(0,s.jsx)("h2",{children:"What the bot is seeing"}),(0,s.jsxs)("span",{className:"live-meta",children:[m.signalsSeen," signal",1===m.signalsSeen?"":"s"," / ",m.declined," declined",m.paused?" / PAUSED":""]})]}),(0,s.jsx)("div",{className:"obs",children:m.markets.map(e=>(0,s.jsxs)("div",{className:`ob ${"signal"===e.status?"hot":""}`,children:[(0,s.jsxs)("div",{className:"ob-top",children:[(0,s.jsx)("strong",{children:e.symbol}),(0,s.jsxs)("span",{className:"tf",children:[e.timeframe,e.higherTimeframe?` under ${e.higherTimeframe}`:""]})]}),(0,s.jsxs)("div",{className:"trends",children:[(0,s.jsxs)("span",{className:`pill ${e.trend??"none"}`,children:[e.timeframe," ",e.trend??"no trend"]}),e.higherTimeframe&&(0,s.jsxs)("span",{className:`pill ${e.higherTrend??"none"}`,children:[e.higherTimeframe," ",e.higherTrend??"no trend"]}),e.trend&&e.higherTrend&&e.trend!==e.higherTrend&&(0,s.jsx)("span",{className:"pill blocked",children:"vetoed"})]}),(0,s.jsx)("p",{className:"reason",children:e.reason}),(0,s.jsxs)("div",{className:"ob-facts",children:[null!=e.price&&(0,s.jsxs)("span",{children:["price ",e.price]}),null!=e.atr&&(0,s.jsxs)("span",{children:["ATR ",e.atr.toFixed(2)]}),null!=e.spreadFractionOfAtr&&(0,s.jsxs)("span",{className:e.spreadFractionOfAtr>.25?"warn":"",title:"Spread as a fraction of ATR. This ratio decided every result measured.",children:["spread ",(100*e.spreadFractionOfAtr).toFixed(1),"% of ATR"]}),e.barClosedAt&&(0,s.jsxs)("span",{children:["bar ",new Date(e.barClosedAt).toISOString().slice(11,16)," UTC"]})]})]},e.symbol))}),m.topReasons.length>0&&(0,s.jsxs)("div",{className:"reasons",children:[(0,s.jsx)("span",{className:"reasons-label",children:"Why it is waiting"}),m.topReasons.map(([e,a])=>(0,s.jsxs)("div",{className:"reason-row",children:[(0,s.jsx)("span",{className:"count",children:a}),(0,s.jsx)("span",{children:e})]},e))]}),m.refusals.length>0&&(0,s.jsxs)("div",{className:"reasons",children:[(0,s.jsx)("span",{className:"reasons-label",children:"Qualified but declined"}),m.refusals.slice(0,6).map((e,a)=>(0,s.jsxs)("div",{className:"reason-row",children:[(0,s.jsx)("span",{className:"count",children:new Date(e.at).toISOString().slice(11,16)}),(0,s.jsxs)("span",{children:[(0,s.jsxs)("strong",{children:[e.symbol," ",e.direction]}),e.pattern?` (${e.pattern})`:""," - ",e.reason]})]},a))]}),m.events.length>0&&(0,s.jsxs)("details",{className:"log",children:[(0,s.jsxs)("summary",{children:["Activity log (",m.events.length,")"]}),(0,s.jsx)("pre",{children:m.events.join("\n")})]})]}),e&&e.bots.length>0&&(0,s.jsxs)("div",{className:"total",children:[(0,s.jsx)("span",{children:"Combined"}),(0,s.jsx)("strong",{className:n(b),children:i(b)})]}),(0,s.jsx)("style",{children:`
